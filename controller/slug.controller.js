...
const insert = async (req, res) => {
    ...
    try {
        ...
        const {
            ...
            description,
            // params
            param1, paramvalue1, param_img1, param_url1,
            param2, paramvalue2, param_img2, param_url2,
            param3, paramvalue3, param_img3, param_url3,
            param4, paramvalue4, param_img4, param_url4,
            param5, paramvalue5, param_img5, param_url5,
            param6, paramvalue6, param_img6, param_url6,
            param7, paramvalue7, param_img7, param_url7,
            param8, paramvalue8, param_img8, param_url8,
            param9, paramvalue9, param_img9, param_url9,
            param10, paramvalue10, param_img10, param_url10,
            banner_img, metatitle, metadesc, keywords_tag,
            tag1, tag2, tag3, schemaid, nic_name,
            col_width, featured_img, video_url,
            type, old_url, status = true,
            addedby = "Admin",
        } = req.body;
        ...
        if (parent_id === 0) {
            ...
            if (!parentSlugDoc) {
                return res.status(400).json({ status: false, message: 'Parent slug not found', data: false });
            }
